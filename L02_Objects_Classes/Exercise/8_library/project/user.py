...
# In the user.py file, create the class User. Upon initialization,
# it should receive user_id (int) and username (string). The class should also
# have an instance attribute books that is an empty list. You should also create
# 2 instance methods:
