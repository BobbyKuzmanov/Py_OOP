...
# a price (float), and ingredients (dictionary).
...
#     - If we already have this ingredient in our pizza, increase the ingredient quantity with
...
#     - Otherwise, remove the given quantity of the ingredient and update the pizza price by removing
#     the ingredient price for the given quantity
# • make_order()
...
#     - Keep in mind that once the pizza is ordered, no further changes are allowed. We should return
# the following message if the customer tries to change it:
