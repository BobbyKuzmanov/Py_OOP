...
#     • When you concatenate two people, you should return a new instance of a person
# who will take the first name from the first person and the surname from the second person.
