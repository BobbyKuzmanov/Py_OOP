...
#     • fill(ml) - fills the glass with the given milliliters if there is enough space in it and
#     returns "Glass filled with {ml} ml", otherwise returns "Cannot add {ml} ml"
