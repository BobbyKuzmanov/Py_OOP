...
# Create a class called Flower. Upon initialization, the class should receive a name (string) and
# a water_requirements (number). The flower should also have an instance attribute called is_happy (False by default).
...
#     should return "{name} is not happy".Create a class called Flower. Upon initialization,
