...
#     • debit(amount) - if the amount is less than or equal to the balance, reduce the balance by the amount and
#     return the new balance. Otherwise, return "Amount exceeded balance"
