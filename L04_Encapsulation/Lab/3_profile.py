...
#     • username: str - the username should be between 5 and 15 characters (inclusive). If it is not,
#     raise a ValueError with the message "The username must be between 5 and 15 characters."
#     • password: str - the password must be at least 8 characters long; it must contain at least one upper
#     case letter and at least one digit. If it does not, raise a ValueError with the message
...
#
# Output:
# ValueError: The password must be 8 or
# more characters with at least 1 digit
